...
import { SDMBar } from "@/Pages/Guest/Renstra/sdm/sdm-bar";
...
import { DiklitChart } from "./sdm/diklit-chart";
...
export default function SDMDashboard({ tahun }: { tahun: number }) {
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Pelatihan Pendidikan dan Penelitian Rumah Sakit</CardTitle>
        </CardHeader>
        <CardContent>
          <DiklitChart props={tahun} />
        </CardContent>
      </Card>
    </>
  );
